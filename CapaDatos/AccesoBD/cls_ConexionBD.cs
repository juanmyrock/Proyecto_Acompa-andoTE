...
namespace CapaDatos
{
    public abstract class cls_ConexionBD
    {
        ...
        {
            conexion = @"Server=NTBK014\SQLEXPRESS; Database=ProyectoAT; User Id=NTBK014\Usuario; Integrated Security=True;"; // Si no usamos Integrated Security (por defecto de Windows)
