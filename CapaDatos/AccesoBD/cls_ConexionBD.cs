...
namespace CapaDatos
{
    public abstract class cls_ConexionBD
    {
        ...
        {
            conexion = $"Server=DESKTOP-QO19H3K; Database=ProyectoAT; User Id=DESKTOP-QO19H3K\\Usuario; Integrated Security=True;"; // Si no usamos Integrated Security (por defecto de Windows)
